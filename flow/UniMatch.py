...
from flow.backbone import CNNEncoder
from flow.opticalflow_transformer import FeatureTransformer
from flow.matching import (global_correlation_softmax, local_correlation_softmax, local_correlation_with_flow,
                       global_correlation_softmax_stereo, local_correlation_softmax_stereo,
                       correlation_softmax_depth)
from flow.attention import SelfAttnPropagation
from flow.geometry import flow_warp, compute_flow_with_depth_pose
from flow.reg_refine import BasicUpdateBlock
from flow.flow_utils import normalize_img, feature_add_position, upsample_flow_with_mask
                    ...
                    for refine_iter_idx in range(num_reg_refine):
                        ...
                        if task == 'stereo':
                            ...
                            if pred_bidir_depth and refine_iter_idx == 0:
                                ...
                                pose = torch.cat((pose, verse(pose)), dim=0)
